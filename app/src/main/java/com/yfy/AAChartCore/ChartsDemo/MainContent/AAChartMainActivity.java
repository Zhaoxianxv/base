...
import com.yfy.AAChartCore.ChartsDemo.AdditionalContent.DoubleChartsLinkedWorkActivity;
import com.yfy.AAChartCore.ChartsDemo.AdditionalContent.JSFormatterFunctionActivity;
import com.yfy.AAChartCore.ChartsDemo.AdditionalContent.DrawChartWithAAOptionsActivity;
import com.yfy.AAChartCore.ChartsDemo.AdditionalContent.EvaluateJSStringFunctionActivity;
import com.yfy.AAChartCore.ChartsDemo.AdditionalContent.HideOrShowChartSeriesActivity;
import com.yfy.AAChartCore.ChartsDemo.AdditionalContent.OnlyRefreshChartDataActivity;
import com.yfy.AAChartCore.ChartsDemo.AdditionalContent.ScrollableChartActivity;
import com.yfy.base.R;

import androidx.appcompat.app.AppCompatActivity;


public class AAChartMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.aa_chart_main);
    ...
    void  setupExpandableListView() {
        ...
        ExpandableListView listView = findViewById(R.id.exlist_lol);
        ...
        listView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
               String chartType = chartTypeArr[groupPosition][childPosition];
                ...
                Toast.makeText(AAChartMainActivity.this, "你点击了：" + chartTypeNameArr[groupPosition][childPosition], Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
