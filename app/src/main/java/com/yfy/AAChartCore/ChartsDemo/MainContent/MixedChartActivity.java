...
import com.yfy.AAChartCore.AAChartCoreLib.AAOptionsModel.AAPie;
...
public class MixedChartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.aa_mixed_chart);
    ...
    private AAChartModel configureTheAAChartModel(String chartType) {
        switch (chartType) {
            case "arearangeMixedLine": return  arearangeMixedLine();
            case "columnrangeMixedLine": return columnrangeMixedLine();
            case "stackingColumnMixedLine": return stackingColumnMixedLine();
            case "dashStyleTypeMixed": return dashStyleTypeMixed();
            case "negativeColorMixed": return negativeColorMixed();
            case "scatterMixedLine": return scatterMixedLine();
            case "negativeColorMixedBubble": return negativeColorMixedBubble();
