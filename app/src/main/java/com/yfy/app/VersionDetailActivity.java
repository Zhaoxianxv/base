...
//        version_site.setText("地址：成都市青羊区青森小区南侧");
        ...
        version.setText(StringUtils.stringToGetTextJoint(
                "(Version\t\t%1$s)",
                AppLess.$vername()));
        version_admin.setText(StringUtils.stringToGetTextJoint(
                "Copyright(c) %1$s.All rights reserved.",
                mActivity.getResources().getString(R.string.app_school_name)));
//        version_admin.setText("Copyright(C) 2013 JinCheng Primary School of Chengdu Hi-Tech Zone");
        ...
        version_tell.setText(StringUtils.stringToGetTextJoint(
                "联系电话：%1$s",
                "028-85311847"));
    }
