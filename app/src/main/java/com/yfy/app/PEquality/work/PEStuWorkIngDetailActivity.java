...
public class PEStuWorkIngDetailActivity extends HttpPostActivity implements HttpNetHelpInterface , AssetsGetFileData {
    private static final String TAG = PEStuWorkIngDetailActivity.class.getSimpleName();
