...
public class RadarUtil {
     ...
     * @return
     */
//    private static RadarPointBean computeStartPoint(String text, float x, float y, Paint paint, MPPointF anchor, float angleDegrees) {
...
//        final float labelRotationAngleDegrees = compositeRadar.getRotationAngle();
...
//
//            Utils.getPosition(center, compositeRadar.getYRange() * factor + xAxis.mLabelRotatedWidth / 2f, angle, pOut);
//
//            pointBeans.add(computeStartPoint(label, pOut.x, pOut.y - xAxis.mLabelRotatedHeight / 2.f, mXAxisRenderer.getPaintAxisLabels(), drawLabelAnchor, labelRotationAngleDegrees));
//        }
//        return pointBeans;
//    }
     ...
     * @return
     */
    public static XAxisRendererRadarChart getXAxisRendererRadarChart(RadarChart compositeRadar) {
        try {
