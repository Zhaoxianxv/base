 ...
 * Date: 2021/1/20
 */
public class DutyEvaluateStuNormalAdapter extends BaseRecyclerAdapter {


    private List<KeyValue> dataList;

    public DutyEvaluateStuNormalAdapter(Activity mContext) {
        super(mContext);
    ...
    public ReViewHolder initViewHolder(ViewGroup parent, int position) {
        ...
        if (position == TagFinal.TYPE_ITEM) {
            return new ItemHolder(inflater.inflate(R.layout.duty_evaluate_stu_normal_item, parent, false));
        }
