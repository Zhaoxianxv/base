...
public class TimePickerDialog {
    ...
    private View initDatePicker() {
        View inflate = LayoutInflater.from(mContext).inflate(R.layout.view_time_datepicker_layout, null);
        mDatePicker = (DatePicker) inflate.findViewById(R.id.datePicker);
//        ((ViewGroup)mDatePicker.getChildAt(0)).getChildAt(0)).getChildAt(0).setVisibility(View.GONE);
//        ((ViewGroup)((ViewGroup) mDatePicker.getChildAt(0)).getChildAt(0)).getChildAt(0).setVisibility(View.GONE);
    ...
    private View initTimePicker() {
        View inflate = LayoutInflater.from(mContext).inflate(R.layout.view_time_timepicker_layout, null);
    ...
    private View initDateAndTimePicker() {
        View inflate = LayoutInflater.from(mContext).inflate(R.layout.view_time_dateandtimepicker_layout, null);
